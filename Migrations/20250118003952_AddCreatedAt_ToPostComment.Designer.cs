...
namespace FeedBackWebApi.Migrations
{
    ...
    [Migration("20250118003952_AddCreatedAt_ToPostComment")]
    partial class AddCreatedAt_ToPostComment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FeedBackWebApi.Models.PostComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Keep going",
                            CreatedAt = new DateTime(2025, 1, 17, 1, 39, 51, 368, DateTimeKind.Local).AddTicks(2210),
                            FullName = "Astri05"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 16, 1, 39, 51, 368, DateTimeKind.Local).AddTicks(2255),
                            FullName = "Martin"
                        });
                });
